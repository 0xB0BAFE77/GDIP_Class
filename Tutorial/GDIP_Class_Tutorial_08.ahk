...
Tut8(){
   ...
   pBrush := gdip.Gdip_BrushCreateSolid(0xaa000000)      ; Create a partially transparent, black brush (ARGB = Transparency, red, green, blue) to draw a rounded rectangle with
   ...
   gdip.Gdip_FillRoundedRectangle(G, pBrush, 0, 0, Width, Height, 20)
   ...
   If !gdip.Gdip_FontFamilyCreate(Font)
   {
   ...
   gdip.Gdip_TextToGraphics(G, "Tutorial 8`n`nThank you for trying this example", Options, Font, Width, Height)
