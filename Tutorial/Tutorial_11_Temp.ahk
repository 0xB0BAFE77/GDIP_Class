...
if (Gdip_LibraryVersion() < 1.45)
{
	MsgBox, 48, version error!, Please download the latest version of the gdi+ library.`nGo to download
	ExitApp
}
...
bra_name    := "Gdip.tutorial.file-fish.bra"
url1        := "https://github.com/tariqporter/Gdip/blob/master/Gdip.tutorial.file-fish.bra?raw=true"
url2        := "https://github.com/tariqporter/Gdip/raw/master/Gdip.tutorial.file-fish.bra"
If !FileExist(bra_name)
    UrlDownloadToFile, % url2, % bra_name
If !FileExist(bra_name)
{
...
hbm := CreateDIBSection(WinWidth, WinHeight)
